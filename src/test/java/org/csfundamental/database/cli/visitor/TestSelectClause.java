...
import org.csfundamental.database.categories.Proj99Tests;
import org.csfundamental.database.categories.SystemTests;
...
public class TestSelectClause {
    ...
    public void beforeEach() throws Exception {
        ...
        this.fileDir = testDir.getAbsolutePath();
        this.db = new Database(fileDir, 32);
    ...
    public void testSimpleSelect() {
        SelectStatementVisitor v = parse(
                "SELECT stu.* FROM Students AS stu WHERE sid > -2.1;"
        );
