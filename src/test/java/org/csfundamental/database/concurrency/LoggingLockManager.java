//package org.csfundamental.database.concurrency;
//
...
//
//    @Override
//    public void release(TransactionContext transaction, ResourceName resource) {
//        emit("release " + transaction.getTransNum() + " " + resource);
//
//        Boolean[] oldOverride = new Boolean[1];
//        loggingOverride.compute(Thread.currentThread().getId(), (id, old) -> {
//            oldOverride[0] = old;
...
//        });
//        try {
//            super.release(transaction, resource);
//        } finally {
//            loggingOverride.compute(Thread.currentThread().getId(), (id, old) -> oldOverride[0]);
//        }
//    }
